...
public class Login extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<FaqModelo> faqs = uf.loadFaqs();
		
		for(int i = 0; i< faqs.size();i++) {
			System.out.print(faqs.get(i).getFaqId()+" ");
			System.out.print(faqs.get(i).getQuestion()+" ");
			System.out.print(faqs.get(i).getAnswer()+" \n");
		}
		
		session.setAttribute("faq", faqs);
