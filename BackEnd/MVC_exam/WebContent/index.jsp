...
<section>
	<c:forEach items="${requestScope.socialLista}" var="social">
		<form id="tableForm" action="/SocailItemEdit" method="get">
			<tr>
				<td form="tableForm" name="asideTitle"><h2><c:out value="${social.name}"/></h2></td>
				<td><a href="<c:out value="${social.url}"/>"><img src="img/<c:out value="${social.logo}"/>"/></a></td>
